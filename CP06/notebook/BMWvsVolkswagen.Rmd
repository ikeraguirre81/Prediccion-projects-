...
EL vector autorregresivo se utiliza para estudiar la relación bidireccional entre las variables, es decir, todas influyen en todas. Puesto que se aplica a series estacionarias, utilizaremos las diferencias para realizar la conversión.
...
```{r, include = FALSE}
auto = na.exclude(cbind(bmw.ret, volks.ret))
```
